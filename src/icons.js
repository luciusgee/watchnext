...
const P = {
  ...
  /* ── chrome ── */
  /* Feather's gear, scaled to 0.9 about the centre. The previous copy had been
     shrunk by hand and its outline sat 0.8 units right of the inner circle —
     visibly off-centre at the size the top bar draws it. */
  settings:
    '<circle cx="12" cy="12" r="3.1"/><path d="M18.66 14.7a1.485 1.485 0 0 0 .297 1.638l.054 .054a1.8 1.8 0 0 1 0 2.547 1.8 1.8 0 0 1-2.547 0l-.054-.054a1.485 1.485 0 0 0-1.638-.297 1.485 1.485 0 0 0-.9 1.359V20.1a1.8 1.8 0 0 1-1.8 1.8 1.8 1.8 0 0 1-1.8-1.8v-.081A1.485 1.485 0 0 0 9.3 18.66a1.485 1.485 0 0 0-1.638 .297l-.054 .054a1.8 1.8 0 0 1-2.547 0 1.8 1.8 0 0 1 0-2.547l.054-.054a1.485 1.485 0 0 0 .297-1.638 1.485 1.485 0 0 0-1.359-.9H3.9a1.8 1.8 0 0 1-1.8-1.8 1.8 1.8 0 0 1 1.8-1.8h.081A1.485 1.485 0 0 0 5.34 9.3a1.485 1.485 0 0 0-.297-1.638l-.054-.054a1.8 1.8 0 0 1 0-2.547 1.8 1.8 0 0 1 2.547 0l.054 .054a1.485 1.485 0 0 0 1.638 .297H9.3a1.485 1.485 0 0 0 .9-1.359V3.9a1.8 1.8 0 0 1 1.8-1.8 1.8 1.8 0 0 1 1.8 1.8v.081a1.485 1.485 0 0 0 .9 1.359 1.485 1.485 0 0 0 1.638-.297l.054-.054a1.8 1.8 0 0 1 2.547 0 1.8 1.8 0 0 1 0 2.547l-.054 .054a1.485 1.485 0 0 0-.297 1.638V9.3a1.485 1.485 0 0 0 1.359 .9H20.1a1.8 1.8 0 0 1 1.8 1.8 1.8 1.8 0 0 1-1.8 1.8h-.081a1.485 1.485 0 0 0-1.359 .9z"/>',
  plus: '<path d="M12 5.2v13.6"/><path d="M5.2 12h13.6"/>',
  /* The feed: a phone-shaped card with a play mark — scrolling films. */
  feed: '<rect x="6.2" y="3.2" width="11.6" height="17.6" rx="2.6"/><path d="M10.6 9.4v5.2l4.2-2.6z" fill="currentColor" stroke="none"/>',
  comment:
    '<path d="M5.4 5.2h13.2a1.8 1.8 0 0 1 1.8 1.8v8.2a1.8 1.8 0 0 1-1.8 1.8H10.2l-4.4 3.4V17h-.4a1.8 1.8 0 0 1-1.8-1.8V7a1.8 1.8 0 0 1 1.8-1.8z"/>',
  bell: '<path d="M6.6 16.6V11a5.4 5.4 0 0 1 10.8 0v5.6l1.6 1.6H5z"/><path d="M10.2 20.2a2 2 0 0 0 3.6 0"/>',
  ...
  /* Superlike: a must-watch. */
  flame: '<path d="M12 3.2c.5 2.9 5.6 5.4 5.6 10.4a5.6 5.6 0 0 1-11.2 0c0-2.6 1.3-4.4 2.6-5.6.1 1.8.8 3 1.9 3.6-.2-3.4.3-6.1 1.1-8.4z"/>',
  flameFill:
    '<path d="M12 3.2c.5 2.9 5.6 5.4 5.6 10.4a5.6 5.6 0 0 1-11.2 0c0-2.6 1.3-4.4 2.6-5.6.1 1.8.8 3 1.9 3.6-.2-3.4.3-6.1 1.1-8.4z" fill="currentColor"/><path d="M12 20.2a2.3 2.3 0 0 1-2.3-2.3c0-1.5 1.2-2.4 2.3-3.7 1.1 1.3 2.3 2.2 2.3 3.7a2.3 2.3 0 0 1-2.3 2.3z" fill="#0b0a09" stroke="none"/>',
  calendar:
